...
variable "ut_frontend_registry_uri" {
  ...
  default     = "ghcr.io/understand-tech/ut-frontend-customer:latest"
  type        = string
}
...
variable "ut_api_registry_uri" {
  ...
  default     = "ghcr.io/understand-tech/ut-api-customer:latest"
  type        = string
}
...
variable "ut_worker_registry_uri" {
  ...
  default     = "ghcr.io/understand-tech/ut-worker-customer:latest"
  type        = string
}
...
variable "llm_registry_uri" {
  ...
  default     = "ghcr.io/understand-tech/ut-llm-customer:latest"
  type        = string
}
