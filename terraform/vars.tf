...
variable "ut_api_registry_uri" {
  ...
  default     = "ghcr.io/understand-tech/ut-api-customer:1.0.2-release"
  type        = string
}
...
variable "ut_worker_registry_uri" {
  ...
  default     = "ghcr.io/understand-tech/ut-worker-customer:1.0.2-release"
  type        = string
}
...
variable "llm_registry_uri" {
  ...
  default     = "ghcr.io/understand-tech/ut-llm-customer:1.0.2-release"
  type        = string
}
