...
| OLLAMA_MODEL_LLM             | Yes      | HuggingFace path to the main LLM model used for answering user questions              | hf.co/bartowski/Qwen2.5-14B-Instruct-1M-GGUF:Q8_0 (Standard) or qwen3:32b-q4_K_M (Reasoning capabilities) |
| OLLAMA_MODEL_CONDENSE_LLM    | Yes      | HuggingFace path to the LLM used for query rewriting/context condensation             | hf.co/bartowski/Qwen2.5-14B-Instruct-1M-GGUF:Q2_K |
...
| Parameter | Value|
|-----------|------|
| Docker image | ghcr.io/understand-tech/ut-api-customer:1.0.2-release |
| vCPU | 4 |
| Memory | 8 Go |
| TCP port | 8501 |
| Storage* | 10 Go |
...
| Parameter | Value|
|-----------|------|
| Docker image | ghcr.io/understand-tech/ut-worker-customer:1.0.2-release |
| vCPU | 4 |
| Memory | 8 Go |
| TCP port | N/A |
| Storage* | 10 Go |
...
| Parameter | Value|
|-----------|------|
| Docker image | ghcr.io/understand-tech/ut-llm-customer:1.0.2-release |
| vCPU | 86 |
| Memory | 176 Go |
| TCP port | 8000 |
| Storage | 500 Go |
...
| <a name="input_llm_registry_uri"></a> [llm\_registry\_uri](#input\_llm\_registry\_uri) | URI used to download UT LLM docker image | `string` | `"ghcr.io/understand-tech/ut-llm:1.0.2-release"` | no |
...
| <a name="input_ut_api_registry_uri"></a> [ut\_api\_registry\_uri](#input\_ut\_api\_registry\_uri) | URI used to download UT API docker image | `string` | `"ghcr.io/understand-tech/ut-api:1.0.2-release"` | no |
...
| <a name="input_ut_worker_registry_uri"></a> [ut\_worker\_registry\_uri](#input\_ut\_worker\_registry\_uri) | URI used to download UT Worker docker image | `string` | `"ghcr.io/understand-tech/ut-worker:1.0.2-release"` | no |
